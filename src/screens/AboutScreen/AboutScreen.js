      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.textContainer}>
            ...
            >
              This App helps you remember every word you looked up on
              dictionary. According to modern pedagogy methods, if you look up a
              word, and will be reminded in 3 days, 7 days and one month about
              that word, you will NEVER forget it.
            </Text>
          </View>
        </View>
      </ScrollView>
